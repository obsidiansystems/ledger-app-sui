...
in {
  ...
  // lib.mapAttrs' (n: lib.nameValuePair ("linux--nanos--" + n)) (builtins.removeAttrs perSystem.x86_64-linux.nanos ["stack-check" "stack-check-with-logging" "test" "test-with-logging"])
